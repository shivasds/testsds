    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            ...
            <div class="box box-info">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form class="form-horizontal" method="post" action="<?= site_url('admin/blog') ?>" enctype="multipart/form-data">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10 <?= form_error('content') ? 'has-error' : '' ?>">
                                <textarea class="form-control" name="content" id="first_content" placeholder="Type the Content Here" rows="5"><?= set_value('content'); ?></textarea>
