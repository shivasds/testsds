                ...
                <div class="row">
                    <div class="col-md-10 col-md-offset-1 border-blue">
                        ...
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-8"><h2>Edit <b>Blogs</b></h2></div>
                               <!--  <div class="col-sm-4">
                        ...
                        <table class="table table-striped table-hover table-bordered">
                                  <thead>
                                      <tr>
                                          ...
                                          <th>Meta Title <i class="fa fa-sort"></i></th>
                                          <th>Image</th>
                                          <th>Actions</th>
                                      </tr>
                                  </thead>
                                  <tbody>
                                      <tr>
                                        ...
                                        foreach ($content as $test) { 
                                          ...
                                          <td><?=$test['title']?></td>
                                          <td><?=$test['author']?></td>
                                          <td><?=$test['meta_title']?></td>
                                          <td><?="<img src=".base_url("uploads/blog_images/".$test['image'])." style='height: 90px; width: 90px;'>"?></td>
                                           
                                          <td>
                                            <!-- <a href="#" class="view" title="View" data-toggle="tooltip"><i class="material-icons">&#xE417;</i></a> -->
                                              <a href="<?=base_url('admin/edit_blog/').$test['id'];?>" class="edit" title="Edit" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
                                              <a href="<?=base_url('admin/delete_blog/').$test['id'];?>" class="delete" title="Delete" data-toggle="tooltip"><i class="material-icons">&#xE872;</i></a>
                                          </td>
                                      </tr>
                                      <?php
                                      }
